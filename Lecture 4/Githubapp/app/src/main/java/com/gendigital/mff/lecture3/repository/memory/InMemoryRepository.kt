package com.gendigital.mff.lecture3.repository.memory
...
class InMemoryRepository: Repository {
    ...
    override fun getUserRepository(username: String): Result<List<GithubRepository>> {
        ...
        user.onSuccess {
            ...
            return if (repositories == null) Result.failure(IOException("Failed to get repositories")) else Result.success(repositories)
