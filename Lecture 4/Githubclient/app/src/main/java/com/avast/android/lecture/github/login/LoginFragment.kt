...
class LoginFragment: Fragment() {
    ...
    private fun fireNotification(login: String) {
        ...
        // Setup intent to open desired activity
        ...
        // Build task (activity stack) to make hierarchical navigation working
        ...
        // Create notification
        val notification =
            NotificationCompat.Builder(requireContext(), App.NOTIFICATION_CHANNEL_MAIN_ID)
                .setSmallIcon(R.drawable.ic_done)
                .setContentTitle(getString(R.string.notification_hello_world_title, login))  // Check string placeholders
